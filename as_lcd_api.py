...
class LcdApi:
    ...
    def hal_sleep_us(self, usecs):
        ...
        # BUT: us sleep not actually feasible/meaningful in asyncio context. So actually
        # convert to ms and force minimum value of 1ms.
        ms =  max((usecs // 1000), 1) # min no-zero ayncio.sleep is 1ms
